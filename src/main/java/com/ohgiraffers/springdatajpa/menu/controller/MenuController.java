...
//    }
    ...
    /* 과제 */
    @GetMapping("/menuName")
    public void seachmenuNamePage(){

    }

    @PostMapping("/menuName")
    public String seachmenuName(@RequestParam String menuName ,Model model){

        List<MenuDTO> menuList =    menuService.serchmenuName(menuName);
        model.addAttribute("menuList",menuList);

        return "menu/searchResult2";
    }

    @PostMapping("/menuPrice")
    public String seachmenuPrice(@RequestParam Integer menuPrice1,@RequestParam Integer menuPrice2,Model model){

        List<MenuDTO> menuList =  menuService.serchmenuPrice(menuPrice1,menuPrice2);
        model.addAttribute("menuList",menuList);
    ...
    public String seachmenuCategory(@RequestParam Integer categoryCode, Model model){

        List<MenuDTO> menuList =    menuService.serchCategoryCode(categoryCode);
        model.addAttribute("menuList",menuList);
